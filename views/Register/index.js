...
export default function Register() {
  ...
  const { globalState: { users }, setGlobalState } = useContext(GlobalContext)
  ...
  const handleCreateUser = async () => {
    ...
    setGlobalState({ user, view: VIEWS.USERS, users: [...users, user] })
  }
    ...
    <>
      ...
      </View>
      {
        ...
        <Button 
          ...
          bold
          onPress={() => setGlobalState({ view: VIEWS.USERS })}
        />
      }
    </>
  );
